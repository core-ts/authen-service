...
exports.map = map;
exports.deletedFields = ['password', 'disable', 'deactivated', 'suspended', 'lockedUntilTime', 'successTime', 'failTime', 'failCount', 'passwordModifiedTime', 'maxPasswordAge', 'accessDateFrom', 'accessDateTo', 'accessTimeFrom', 'accessTimeTo', 'twoFactors', 'history'];
...
exports.fields = ['userId', 'displayName', 'lockedUntilTime', 'successTime', 'failTime', 'failCount', 'passwordModifiedTime', 'maxPasswordAge', 'userType', 'accessDateFrom', 'accessDateTo', 'accessTimeFrom', 'accessTimeTo', 'twoFactors', 'dateFormat', 'timeFormat', 'imageURL'];
function createMap() {
  var m = {};
...
var SqlUserRepository = (function () {
  ...
  SqlUserRepository.prototype.getUser = function (username) {
    ...
    return this.db.query(this.query, [username]).then(function (v) {
      return !v || v.length <= 0 ? undefined : getUser(map(v[0], _this.map), c.status, _this.status, c.maxPasswordAge);
    });
  };
